...
// Legacy AdminConfig/X-Admin-Token removed; diagnostics updated for JWT-only flows.
...
class _DiagnosticsScreenState extends ConsumerState<DiagnosticsScreen> {
  ...
  // Admin token diagnostics card removed — admin endpoints now use JWT Bearer only.
